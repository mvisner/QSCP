...
Want to learn more? have a look at this website I built for more information. 
\
...
Downloading the data in a format that contains all the information we want is a bit tricky. To make things easier, I gathered all the files in a zip file which you can download ---here---.
